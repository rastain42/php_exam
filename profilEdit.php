 ...
 if(isset($_POST["editMDP"])){  
    if(isset($_POST["password"] ) && isset($_POST["passwordConfirm"] )){  
        ...
        if($password == $passwordConfirm){
            ...
            echo '<script>les mots de passe ne sont pas les mêmes !")</script>'; 
        }
    }else {  
        echo '<script>alert("WTF?, y\'a rien d\'écrit !")</script>';  
    }    
    ...
    <div class="container rounded bg-white mt-5 mb-5">
        <div class="row">
            <div class="col-md-3 border-right">
                <div class="d-flex flex-column align-items-center text-center p-3 py-5"><img class="rounded-circle mt-5" alt width="200px" height="200px"  src="<?php echo $ProfilPic ?>"></div>
            </div>
